...
--
-- Host: localhost
-- Generation Time: Jun 02, 2024 at 10:39 AM
...
CREATE TABLE `Products` (
  ...
  `discount_type` enum('percentage','buy_n_get_m') DEFAULT NULL,
  `discount_value` decimal(5,2) DEFAULT NULL,
  `discount_buy` int(11) DEFAULT NULL,
  `discount_get` int(11) DEFAULT NULL,
...
INSERT INTO `Products` (`product_id`, `name`, `description`, `price`, `tags`, `stock`, `discount_type`, `discount_value`, `discount_buy`, `discount_get`, `start_date`, `end_date`) VALUES
(1, 'Venturini', 'Premium Quality Formal Shoe', 2300.00, 'shoe,summer', 200, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Earth Shoes', 'Elegant looking best for regular use.', 1100.00, 'regular_use', 100, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'School Shoes', 'White shoes for school going students.', 1000.00, 'school,shoe', 200, NULL, NULL, NULL, NULL, NULL, NULL);
